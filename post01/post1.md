...
![Error for loading the package.](./post1_pic1.png)

Then type `install.packages(DataComputing)` to install the package. You will also get this error.

![Error for downloading the package.](./post1_pic2.png)
...
![Downloading devtools package.](./post1_pic3.png)
...
![Downloading DataComputing package by using devtools](./post1_pic4.png)
...
![](post1_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-5-1.png)
...
![](post1_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-9-1.png)
